  ...
  <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
    ...
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
        ...
        <div class="flex items-center lg:order-2">
            ...
            <a href="/ASHMS_React/login" class="text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 focus:outline-none">Login</a>

        </div>
        <div class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
            <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                <li>
                    <a href="/ASHMS_React" class="block py-2 pl-3 pr-4 text-white bg-red-600 rounded lg:bg-transparent lg:text-red-600 lg:p-0 dark:text-white" aria-current="page">Home</a>
                </li>
                <li>
                    <a href="/ASHMS_React/about" class="navbartitle2">About</a>
                </li>
            </ul>
        </div>
    </div>
