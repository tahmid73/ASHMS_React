        ...
        <div>
            ...
            <div  className="block p-6 rounded-lg shadow-lg bg-white max-w-sm">
              <form>
                ...
                <div  className="form-group mb-6">
                  <input type="email"  className="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleInput91"
                ...
                <div  className="form-group form-check text-center mb-6">
                  ...
                  <label  className="form-check-label inline-block text-gray-800" for="exampleCheck96"></label>
                </div>
